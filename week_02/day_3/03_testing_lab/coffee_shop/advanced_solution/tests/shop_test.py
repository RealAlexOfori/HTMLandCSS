...
class TestShop(unittest.TestCase):
    ...
    def test_drink_names(self):
        ...
        self.shop.add_drink(self.drink_1)
        self.shop.add_drink(self.drink_2)
        self.assertEqual(["mocha", "latte"], self.shop.drink_names())


    def test_drink_names(self):
        poor_customer = Customer("Bob", 3.00, 32, 20)
        self.shop.add_drink(self.drink_1)
        self.shop.add_drink(self.drink_2)
        self.shop.add_drink(self.drink_3)
        self.assertEqual(["mocha", "latte"], self.shop.drinks_customer_can_afford(poor_customer))
